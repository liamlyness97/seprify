...
>
	<div class="flex w-full justify-between px-20 pt-14">
		<div>
			<img src="/seprify.png" alt="Seprify" />
		</div>
		<nav class="font-body flex gap-10 text-white">
	...
	<div
		class="absolute left-0 right-0 top-0 mx-auto flex h-full max-w-7xl flex-col justify-center gap-5"
	>
